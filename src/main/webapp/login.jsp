...
<div style="background-color:white" align="center">
    ...
    <br><Br>
    <h3 style="color:black">Dành riêng cho admin</h3>
    <table>
        <form  method="post" action="/login">
            <tr>
                <th>Tài khoản</th>      <th> <input type="text"  name="name" required="" autocomplete="off"></th>
            </tr>
            <tr>
                <th>Mật khẩu</th>      <th> <input type="password"  name="password" required="" autocomplete="off"></th>
            </tr>
            <tr>
                <th> <input type="submit" value="Đăng nhập" style="background: skyblue "> </th>
            </tr>
        </form>
    </table>
    <Br><br><Br><Br>
